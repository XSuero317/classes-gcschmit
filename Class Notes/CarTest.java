...
public class CarTest
{
    ...
    public void testGetFuelInTank()
    {
         ...
         *      is equal to the returned (actual) value. If not,
         *      the test fails.
         *  Specify the expected value first and the returned value
         *      second.
         *  For doubles (and only doubles), specify a third argument
         *      which is the epsilon (i.e., how close is close
         *      enough to be equal).
         */
